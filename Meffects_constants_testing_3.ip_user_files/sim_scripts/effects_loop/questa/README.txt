...
#
# Generated by export_simulation on Mon Jun 19 16:28:01 +0300 2017
#
################################################################################
...
switch to the './effects_loop.sh' script.

./effects_loop.sh -reset_run
...
./effects_loop.sh -noclean_files

For more information on the script, please type './effects_loop.sh -help'.
