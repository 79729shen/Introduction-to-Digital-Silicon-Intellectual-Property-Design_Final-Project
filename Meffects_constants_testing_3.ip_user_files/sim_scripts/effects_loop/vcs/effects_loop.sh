...
#
# Generated by Vivado on Mon Jun 19 16:28:01 +0300 2017
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: effects_loop.sh [-help]
# usage: effects_loop.sh [-lib_map_path]
# usage: effects_loop.sh [-noclean_files]
# usage: effects_loop.sh [-reset_run]
#
...
# executing this script. Please type 'effects_loop.sh -help' for more information.
#
...
# Design libraries
design_libs=(processing_system7_bfm_v2_0_5 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_9 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_9 fifo_generator_v13_1_1 axi_data_fifo_v2_1_8 axi_crossbar_v2_1_10 axi_protocol_converter_v2_1_9)

# Simulation root library directory
sim_lib_dir="vcs"

# Script info
echo -e "effects_loop.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_processing_system7_0_0/sim/effects_loop_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/family_support.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/common_types.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/pselect_f.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/address_decoder.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/slave_attachment.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/iis_ser.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/iis_deser.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/user_logic.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/axi_lite_ipif.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/zed_audio_ctrl_v1_0/zed_audio_ctrl.srcs/sources_1/imports/i2s_audio/i2s_ctrl.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_zed_audio_ctrl_0_0/sim/effects_loop_zed_audio_ctrl_0_0.vhd" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_rst_processing_system7_0_100M_0/sim/effects_loop_rst_processing_system7_0_100M_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/xilinx.com/xlconstant_v1_1/xlconstant.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_xlconstant_0_0/sim/effects_loop_xlconstant_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/hdl/effects_loop.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_xbar_0/sim/effects_loop_xbar_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/pl_to_ps_v1_0/hdl/PL_to_PS_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/pl_to_ps_v1_0/hdl/PL_to_PS_v1_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_PL_to_PS_0_0/sim/effects_loop_PL_to_PS_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/ps_to_pl_v1_0/hdl/PS_to_PL_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/ps_to_pl_v1_0/hdl/PS_to_PL_v1_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_PS_to_PL_0_0/sim/effects_loop_PS_to_PL_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/control_v1_0/control.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_control_0_0/sim/effects_loop_control_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/clk_slow_v1_0/sources_1/new/clk_slow.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_clk_slow_0_0/sim/effects_loop_clk_slow_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/delay_v1_0/sources_1/new/bram.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/delay_v1_0/sources_1/new/delay.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_delay_0_0/sim/effects_loop_delay_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/trem_v1_0/sources_1/new/trem.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_trem_0_0/sim/effects_loop_trem_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/distortion_v1_0/sources_1/new/Distortion.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_Distortion_0_0/sim/effects_loop_Distortion_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/mclk_gen_v1_0/MCLK_gen.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_MCLK_gen_0_0/sim/effects_loop_MCLK_gen_0_0.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/octaver_v1_0/sources_1/new/bram_oct.vhd" \
    "$ref_dir/../../../bd/effects_loop/ipshared/vl/octaver_v1_0/sources_1/new/octaver.vhd" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_octaver_0_0/sim/effects_loop_octaver_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/effects_loop/ip/effects_loop_auto_pc_0/sim/effects_loop_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.effects_loop xil_defaultlib.glbl -o effects_loop_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./effects_loop_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./effects_loop.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key effects_loop_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc effects_loop_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./effects_loop.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: effects_loop.sh [-help]\n\
Usage: effects_loop.sh [-lib_map_path]\n\
Usage: effects_loop.sh [-reset_run]\n\
Usage: effects_loop.sh [-noclean_files]\n\n\
